"""
Django settings for figo_40093 project.
...
WSGI_APPLICATION = 'figo_40093.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "figo_40093 API",
    "DESCRIPTION": "API documentation for figo_40093 App",
    "VERSION": "v1",
}
